...
// all tokens for the colour designs

export const colourTokens = (mode: string) => ({
...(mode === 'dark') ? {
    grey: {
        100: "#e0e0e0",
        200: "#c2c2c2",
...
export const themeConfig = (mode: string) => {
    const colours = colourTokens(mode)
...
export const useColourMode = () => {
    ...
    return [theme, colourMode] as const
}
